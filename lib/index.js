...
var _CsvCreator = __webpack_require__(20);

var _CsvCreator2 = _interopRequireDefault(_CsvCreator);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _CsvCreator2.default;
...
var CsvCreator = function CsvCreator(props) {
  ...
  var display = children || _react2.default.createElement(
    'p',
    null,
    text
  );
  ...
  function downloadCsv(csvData, csvFileName) {
    ...
    var formattedFileName = csvFileName || new Date().toISOString();
  ...
  function formatData(csvHeaders, csvRows) {
    ...
    if (csvHeaders.length > 0) {
      csvDataArray.push(csvHeaders.reduce(function (result, header) {
    ...
    csvDataArray = csvDataArray.concat(csvRows.map(function (row) {
  ...
  function handleClick() {
    downloadCsv(formatData(noHeader ? [] : headers, rows), filename);
  }
...
CsvCreator.propTypes = {
  ...
  headers: _propTypes2.default.arrayOf(_propTypes2.default.object),
